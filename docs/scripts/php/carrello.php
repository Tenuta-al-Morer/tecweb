    ...
    if ($type === 'active') {
        ...
        $actionsHTML = "
            <form class='qty-selector' action='carrello.php' method='POST'>
                ...
                <button type='submit' name='action' value='aggiorna_quantita' class='hidden-submit visually-hidden'>
                    Aggiorna quantità di $nome
                </button>

                <button type='submit' name='action' value='meno' class='qty-btn cart-action-btn'
                        data-action='meno' data-id-riga='$idR' data-id-vino='$idV'>
                    <span aria-hidden='true'>-</span>
                    <span class='visually-hidden'>Riduci quantità di $nome</span>
                </button>

                <label for='qty_v_$idV' class='visually-hidden'>Quantità per $nome</label>

                <input type='number' name='quantita' id='qty_v_$idV' value='$qty' class='qty-input'
                    min='1' max='$limitMax' data-stock='$stock' data-id-riga='$idR' data-id-vino='$idV'>

                <button type='submit' name='action' value='piu' class='qty-btn cart-action-btn'
                        data-action='piu' data-id-riga='$idR' data-id-vino='$idV'>
                    <span aria-hidden='true'>+</span>
                    <span class='visually-hidden'>Aumenta quantità di $nome</span>
                </button>
            </form>
